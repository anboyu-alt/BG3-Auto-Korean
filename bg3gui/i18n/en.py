...
STRINGS = {
    ...
    "settings.bg3_path": "Baldur's Gate 3 Install Folder",
    ...
    "settings.use_official_glossary": "Reference official language pack",
    "settings.save": "Save",
    ...
    "desc.settings.bg3": "Folder where Baldur's Gate 3 is installed (…\\Baldurs Gate 3). Used to auto-detect the game language and reference official terminology. Usually auto-filled for Steam.",
    ...
    "desc.settings.official": "Uses your installed game's official language packs as a translation reference. Mod text that exactly matches an official term reuses the official translation (saving API calls), and official terms inside sentences are passed to the AI for consistent wording. Requires the BG3 install folder above. The dictionary is built once from your local game files and cached; it is never redistributed.",
    ...
    "desc.review.edit": "Compare source and translation side by side in a table. Double-click the right Translation cell to edit it directly; edited rows are marked as modified (gold).",
    ...
    "glossary.custom_info": "My Glossary overrides the built-in one. Double-click a cell to edit inline; type into the empty bottom row to add a new term. Changes are saved automatically.",
    ...
    "wizard.intro": "Just fill in the items below once. The game folder is usually auto-detected, so you can often just press Start.",
    ...
    "wizard.step_bg3": "2. Baldur's Gate 3 install folder (optional)",
    "wizard.start": "Start",
