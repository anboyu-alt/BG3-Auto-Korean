...
# =============================================================================
# BG3 모드 자동 한글화 스크립트 v2.1 — PAK 직접 모드
# =============================================================================
#
...
#
# 두 버전의 차이:
#   - 이 파일 (v2.1, PAK 모드): .pak 파일을 넣으면 전자동
#     → divine.exe(LSLib)로 언팩 → 번역 → 리팩까지 한번에 처리
#   - BG3_AutoKorean_Folder_v2.1.py (폴더 모드): 이미 언팩된 폴더를 대상으로 번역만 수행
...
if __name__ == "__main__":
    print("=" * 60)
    print("   BG3 모드 자동 한글화 스크립트 v2.1 — PAK 직접 모드")
    print("=" * 60)
    print()
